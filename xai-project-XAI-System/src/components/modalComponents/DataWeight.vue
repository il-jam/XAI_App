  ...
  <div class="outer">
    <div class="cont">
      <div class="weight-row summary-row">
        <CumulativeBarChart :entryData="content" />
        <DropDown
        ...
        >
          ...
          <p>
            ...
            <RiskScore
              :value="content.DatensatzGesamt.GesamtRisikoWert"
          ...
          <span v-if="openedDropdownIndex === index">
            <div>
              ...
              <p>
                ...
                <RiskScore
                  :value="content.DatensatzGesamt.EinzelRisikoWert[index]"
                  style="transform: scale(0.65), font-size: 20px"
                />
              </p>
              <p>
...
import CumulativeBarChart from "./CumulativeBarChart.vue";
